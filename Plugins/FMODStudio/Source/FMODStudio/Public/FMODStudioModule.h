...
public:
	...
	// <ANS - HVALDIVIESO>
	virtual void SetListenerPositionWithOverride(int ListenerIndex, UWorld *World, const FTransform &ListenerTransform, const FVector &AttenuationOverridePosition, float DeltaSeconds) = 0;
	// <ANS - HVALDIVIESO>
